  ...
  return (
    <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-6 border-b border-gray-200 pb-5">
        ...
        <p className="mt-2 text-sm text-gray-500">Mantenha suas informações pessoais e de contato atualizadas.</p>
      </div>
        ...
        <form onSubmit={handleSalvarAlteracoes} className="space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input id="nome" type="text" value={nome} onChange={(e) => setNome(e.target.value)} required placeholder="Seu nome" disabled={estaCarregando} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Input id="telefone" type="text" value={telefone} onChange={(e) => setTelefone(e.target.value)} placeholder="(00) 00000-0000" disabled={estaCarregando} />
            </div>
            <div>
              <label htmlFor="cpf" className="block text-sm font-semibold text-gray-700 mb-1.5">CPF do Titular</label>
              <Input id="cpf" type="text" value={cpf} onChange={(e) => setCpf(e.target.value)} placeholder="000.000.000-00" disabled={estaCarregando} />
            </div>
          </div>
